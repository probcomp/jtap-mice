...
def stepper_model(mo, mi, inference_mode_bool):
    ...
    new_x = genjax.truncated_normal(x_mean, pos_noise, jnp.float32(0.), mi.scene_dim[0] - diameter) @ 'x'
    new_y = y
    ...
    hit_boundary = (new_x <= (0 + epsilon)) | (new_x >= (scene_length - diameter - epsilon))
